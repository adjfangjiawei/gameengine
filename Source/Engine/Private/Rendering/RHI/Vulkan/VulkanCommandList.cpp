    ...
    namespace RHI {
        ...
        void VulkanCommandList::Reset(IRHICommandAllocator* allocator) {
            auto vulkanAllocator =
                static_cast<VulkanCommandAllocator*>(allocator);
            if (!vulkanAllocator) {
        ...
        void VulkanCommandList::ClearRenderTargetView(
            ...
            vkCmdClearColorImage(
                GetCommandBuffer(),
                static_cast<VulkanTexture*>(renderTarget->GetResource())
                    ->GetHandle(),
        ...
        void VulkanCommandList::ClearDepthStencilView(
            ...
            vkCmdClearDepthStencilImage(
                GetCommandBuffer(),
                static_cast<VulkanTexture*>(depthStencil->GetResource())
                    ->GetHandle(),
                VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                &clearValue,
                1,
        ...
        void VulkanCommandList::SetVertexBuffers(
            ...
            for (uint32 i = 0; i < numBuffers; ++i) {
                auto buffer = static_cast<VulkanBuffer*>(views[i].Buffer);
        ...
        void VulkanCommandList::SetIndexBuffer(const IndexBufferView& view) {
            ...
            auto buffer = static_cast<VulkanBuffer*>(view.Buffer);
