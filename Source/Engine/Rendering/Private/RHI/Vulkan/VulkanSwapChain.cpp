...
// 添加 Vulkan 结构体的比较运算符
namespace std {
    bool operator<(const VkDescriptorSetLayoutBinding& a,
                   const VkDescriptorSetLayoutBinding& b) {
        return std::tie(a.binding,
                        a.descriptorType,
                        a.descriptorCount,
                        a.stageFlags) < std::tie(b.binding,
                                                 b.descriptorType,
                                                 b.descriptorCount,
                                                 b.stageFlags);
    }

    bool operator<(const VkPipelineShaderStageCreateInfo& a,
                   const VkPipelineShaderStageCreateInfo& b) {
        return std::tie(a.stage, a.module, a.pName) <
               std::tie(b.stage, b.module, b.pName);
    }

    bool operator<(const VkPushConstantRange& a, const VkPushConstantRange& b) {
    ...
    bool operator<(const VkVertexInputAttributeDescription& a,
        ...
        return std::tie(a.location, a.binding, a.format, a.offset) <
               std::tie(b.location, b.binding, b.format, b.offset);
    }

    bool operator<(const VkVertexInputBindingDescription& a,
                   const VkVertexInputBindingDescription& b) {
        return std::tie(a.binding, a.stride, a.inputRate) <
               std::tie(b.binding, b.stride, b.inputRate);
    }
}  // namespace std
    ...
    namespace RHI {
        ...
        void VulkanSwapChain::Cleanup() {
            ...
            if (Surface != VK_NULL_HANDLE) {
                vkDestroySurfaceKHR(Device->GetPhysicalDevice()->GetInstance(),
                                    Surface,
                                    nullptr);
                Surface = VK_NULL_HANDLE;
            }
        ...
        bool VulkanSwapChain::CreateSurface() {
            ...
            xcb_connection_t* connection =
                static_cast<xcb_connection_t*>(Desc.Connection);
            xcb_window_t window = static_cast<xcb_window_t>(
                reinterpret_cast<uintptr_t>(Desc.WindowHandle));
            ...
            if (vkCreateXcbSurfaceKHR(
                    ...
                    nullptr,
                    &Surface) != VK_SUCCESS) {
                LOG_ERROR("Failed to create XCB window surface!");
                return false;
            }
#endif
        ...
        bool VulkanSwapChain::CreateSwapChain() {
            ...
            uint32_t queueFamilyIndices[] = {
                ...
                VulkanDevicePresent::GetPresentQueueFamilyIndex(Device)};
        ...
        IRHITexture* VulkanSwapChain::GetBackBuffer(uint32 index) {
            ...
            // 使用dynamic_cast来确保类型转换的安全性
            return dynamic_cast<IRHITexture*>(BackBuffers[index].get());
        }
        ...
        void VulkanSwapChain::Present() {
            ...
            vkQueuePresentKHR(VulkanDevicePresent::GetPresentQueue(Device),
                              &presentInfo);
        }
